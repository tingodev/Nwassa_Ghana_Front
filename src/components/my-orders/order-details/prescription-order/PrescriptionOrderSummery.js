    ...
    <CustomStackFullWidth sx={{ padding: "7px 0px 20px 0px" }} spacing={2}>
      ...
      <Stack height="270px" justifyContent="space-between"  >
          <Stack direction="row" gap="10px" flexWrap="wrap">
              {
                  data?.order_attachment?.map((attachment,index)=>{
                      return(
                          <Stack key={index} onClick={()=>handleImageOnClick(attachment)} sx={{ cursor: "pointer",}} >
                              <CustomImageContainer src={`${configData?.base_urls?.order_attachment_url}/${attachment}`} width="80px" />
          ...
          <Stack width="100%" marginTop="auto">
              {trackOrderData?.store_discount_amount > 0 && <CustomStackFullWidth
                  direction="row"
                  alignItems="center"
              ...
              {trackOrderData?.coupon_discount_amount > 0 && <CustomStackFullWidth
                  direction="row"
                  alignItems="center"
                  justifyContent="space-between"
                  spacing={2}
              ...
              }
              {
                  trackOrderData?.tax_status==='included' && <>
                      {trackOrderData?.total_tax_amount > 0 && <CustomStackFullWidth
                          direction="row"
                          alignItems="center"
                          justifyContent="space-between"
                          spacing={2}
                      >
                          <Typography fontWeight="bold">{t("Vat/Tax (Included)")}</Typography>
                          <Typography fontWeight="bold">
              ...
              {trackOrderData?.dm_tips>0 && <CustomStackFullWidth
                  direction="row"
                  alignItems="center"
                  justifyContent="space-between"
                  spacing={2}
        ...
        <CustomModal openModal={openModal} handleClose={handleModalClose}>
           <Stack position='relative'>
               ...
               <CustomImageContainer src={`${configData?.base_urls?.order_attachment_url}/${modalImage}`} width="600px" smWidth="300px"  objectfit="contain"/>
           </Stack>
        </CustomModal>
    </CustomStackFullWidth>
  );
